            ...
            <div className="user-name-box">
                <form action="" className="user-name-change" onSubmit={handleSubmit}>
                    <div className="name-change-box">
                        <p>@</p>
                        <input type="text" className='user-name-input' placeholder='user_name' autoFocus onChange={e => setUserName(e.target.value)} defaultValue={user_name} style={{borderBottomColor: darkMode?'white':'black', color: darkMode?'white':'black'}}/>
