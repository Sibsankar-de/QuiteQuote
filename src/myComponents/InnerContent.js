...
export const InnerContent = (props) => {
    ...
    const [saveContent, setSaveContent] = useState(saveContentList.includes(props.property.feedImg)?true:false);
    const saveContentClickHandeler = () => {
        if (saveContent===false && !saveContentList.includes(props.property.feedImg)){
            setSaveContent(true);
            saveContentList.splice(0, 0, props.property.feedImg);
            localStorage.setItem('saveContentList', JSON.stringify(saveContentList));
        }
        else {
            setSaveContent(false);
            saveContentList.splice(saveContentList.indexOf(props.property.feedImg), 1);
            localStorage.setItem('saveContentList', JSON.stringify(saveContentList));
        }
    }
    ...
    return (
        <>
            ...
            <div className="content-box">
                ...
                <div className="user-bar" style={{backgroundColor: darkMode?'#35363a':'white', borderColor: darkMode?'#262626':'#d0cccc'}}>
                    <div className="user-bar-img">
                        <Link to={props.property.link}>
                            <img src={props.property.dpImg} alt="" width="50px" className="dp-img" draggable={false} onContextMenu={(e) => e.preventDefault()} style={{borderColor: darkMode?'white':'#35363a'}}/>
                        </Link>
                    </div>
                    <div className="user-status">
                        <p className="user-name" style={{color: darkMode?'white':'black'}}>{'@' + props.property.userName}</p>
                ...
                <div className="like-bar" style={{backgroundColor: darkMode?'#35363a':'white', borderColor: darkMode?'#262626':'#d0cccc'}}>
                    <div className="like-nav-opts">
                        <ul>
                        <li><button className="like-button" ><svg xmlns="http://www.w3.org/2000/svg" ref={likeRef}
                            width="30px" height="30px" fill={!isLiked?darkMode?'white':'black':'#e53935'} className={!isLiked ? 'like-btn-svg-unclicked' : 'like-btn-svg-clicked' } 
                        ...
                        <li>
                            <button className="add-comment"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className={!commentDisplay ? 'bi bi-chat-square-text' : 'bi bi-chat-square-text-fill'} viewBox="0 0 16 16" onClick={CommentClick} style={{color: darkMode?'white':'black'}}>
                        ...
                        <li><button className="share"><a href={props.property.feedImg} download="feedImg"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-download" viewBox="0 0 16 16" style={{color: darkMode?'white':'black'}}>
                            <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z" />
                            <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z" />
                        </svg></a></button>
                        </li>
                        <li><button className="save-content" onClick={saveContentClickHandeler}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-bookmark" viewBox="0 0 16 16" style={{color: darkMode?'white':'black'}}>
                            <path d={saveContent?"M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z":
                    ...
                    {commentDisplay && <div className="comment-box" style={{backgroundColor: darkMode?'#202124':'white', borderColor: darkMode?'#262626':'#d0cccc', color: darkMode?'white':'black'}}>
